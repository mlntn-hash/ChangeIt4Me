...
const Footer = () => {
  ...
  <Link href="/">
    ...
    />
            ...
            {/* Описание платформы */}
            <p className="text-[#181818] text-sm leading-relaxed text-[15px] pt-[20px] font-regular">
          ...
          <div>{/*4*/}
            ...
            <div className="mb-6 pr-[10px]">
              ...
              <div className="flex space-x-3 mt-4 justify-center">
                {/* Facebook */}
                <a href="#" className="w-[35px] h-[35px] bg-black rounded-full flex items-center justify-center transform hover:scale-105 duration-300 ease-in-out">
        ...
        <div className="pt-[20px]">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-[#181818]">
            ...
            <div className="flex space-x-6">
              <a href="/privacy" className="hover:text-[#2d4e30] transition-colors duration-500 ease-in-out hover:underline">
                Privacy Policy
              </a>
              <a href="/terms" className="hover:text-[#2d4e30] transition-colors duration-500 ease-in-out hover:underline">
                Terms & Conditions
              </a>
               <a href="https://creavisao.com/" className="hover:text-[#2d4e30] transition-colors duration-500 ease-in-out hover:underline">
                Created by <span className="font-semibold ml-1">CV</span>
              </a>
